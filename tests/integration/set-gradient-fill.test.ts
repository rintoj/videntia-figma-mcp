...
describe("set_gradient_fill tool integration", () => {
  ...
  describe("gradient types", () => {
    it("sends LINEAR gradient", async () => {
      ...
      const res = await callTool("set_gradient_fill", { nodeId: "1:2", gradientType: "LINEAR", gradientStops: twoStops });
      expect(mockSendCommand).toHaveBeenCalledWith("set_gradient_fill", expect.objectContaining({ gradientType: "LINEAR" }));
    ...
    it("sends RADIAL gradient", async () => {
      ...
      const res = await callTool("set_gradient_fill", { nodeId: "1:2", gradientType: "RADIAL", gradientStops: twoStops });
      expect(mockSendCommand).toHaveBeenCalledWith("set_gradient_fill", expect.objectContaining({ gradientType: "RADIAL" }));
    ...
    it("sends ANGULAR gradient", async () => {
      ...
      expect(mockSendCommand).toHaveBeenCalledWith("set_gradient_fill", expect.objectContaining({ gradientType: "ANGULAR" }));
    });
    ...
    it("sends DIAMOND gradient", async () => {
      ...
      expect(mockSendCommand).toHaveBeenCalledWith("set_gradient_fill", expect.objectContaining({ gradientType: "DIAMOND" }));
    });
  ...
  describe("gradient stops", () => {
    it("defaults alpha to 1 when not provided", async () => {
      mockSendCommand.mockResolvedValue({ id: "1:2", name: "Rect", gradientType: "LINEAR", stopsCount: 2 });
      ...
      expect(call.gradientStops[0].color.a).toBe(1);
      expect(call.gradientStops[1].color.a).toBe(1);
    });
  ...
  describe("optional parameters", () => {
    ...
    it("passes custom angle", async () => {
      mockSendCommand.mockResolvedValue({ id: "1:2", name: "Rect", gradientType: "LINEAR", stopsCount: 2 });
      await callTool("set_gradient_fill", { nodeId: "1:2", gradientType: "LINEAR", gradientStops: twoStops, angle: 45 });
    ...
    it("passes custom opacity", async () => {
      mockSendCommand.mockResolvedValue({ id: "1:2", name: "Rect", gradientType: "LINEAR", stopsCount: 2 });
      await callTool("set_gradient_fill", { nodeId: "1:2", gradientType: "LINEAR", gradientStops: twoStops, opacity: 0.5 });

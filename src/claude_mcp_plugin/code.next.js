...
(() => {
  ...
  async function setStrokeColor(params) {
    ...
    return {
      ...
      strokeWeight: "strokeWeight" in node ? node.strokeTopWeight : void 0
    };
  }
  async function setImageFill(params) {
    ...
    if (rotation !== void 0 && ["TILE", "FILL", "FIT"].includes(scaleMode)) {
      imagePaint.rotation = rotation;
    }
    if (exposure !== void 0) {
      imagePaint.exposure = exposure;
    }
    if (contrast !== void 0) {
      imagePaint.contrast = contrast;
    }
    if (saturation !== void 0) {
      imagePaint.saturation = saturation;
    }
    if (temperature !== void 0) {
      imagePaint.temperature = temperature;
    }
    if (tint !== void 0) {
      imagePaint.tint = tint;
    }
    if (highlights !== void 0) {
      imagePaint.highlights = highlights;
    }
    if (shadows !== void 0) {
      imagePaint.shadows = shadows;
    }
    try {
  ...
  async function readMyDesign(params) {
    ...
    const processNode = async (node, currentDepth) => {
      ...
      if ("strokeWeight" in node && node.strokeWeight !== figma.mixed && node.strokeTopWeight > 0) {
  ...
  async function getAnnotations(params) {
    ...
    const rawAnnotations = annotatedNode.annotations || [];
    const annotations = [];
  ...
  async function createFromData(params) {
    ...
    async function createNode(nodeData, parentNode, isRoot, rootX, rootY) {
            ...
            if (jsxType2 === "COMPONENT_SET") {
              ...
              if (existing.type === "TEXT") {
                ...
                try {
                  await figma.loadFontAsync({
                    family,
                    style: getFontStyle2(weight)
                  });
                  textNode.fontName = { family, style: getFontStyle2(weight) };
                } catch (e) {
                  try {
                    await figma.loadFontAsync({
                      family: "Inter",
      ...
      if (node === null && jsxType === "TEXT") {
        ...
        const weight = nodeData["fontWeight"] !== void 0 ? nodeData["fontWeight"] : 400;
        try {
          await figma.loadFontAsync({ family, style: getFontStyle2(weight) });
          textNode.fontName = { family, style: getFontStyle2(weight) };
        } catch (e) {
          try {
  ...
  function hasStrokePaintStyle(node) {
    try {
      var styleId = node.strokeStyleId;
      if (styleId && styleId !== "" && styleId !== figma.mixed) return true;
    } catch (e) {
    }
    return false;
  ...
  function scanNode(node, depth, parent, parentBBox, chk, categories, violations, violationsCappedRef, totalNodesRef) {
    ...
    if (chk.rootFrame && depth === 0 && (nodeType === "FRAME" || nodeType === "COMPONENT")) {
      ...
      if (rfHasLayout) {
        ...
        var rfMinHeightNum = rfMinHeight !== null && rfMinHeight !== void 0 ? rfMinHeight : 0;
    ...
    if (chk.overflow && parent !== null && parent !== void 0 && depth > 1) {
      ...
      var skipOv = ovPositioning === "ABSOLUTE" || ovName.indexOf("Icon/") === 0 || ovName.indexOf("Image/") === 0;
      if (!skipOv) {
        var childBBox = null;
        try {
    ...
    for (var fxi = 0; fxi < violations.length; fxi++) {
      ...
      if (isRootFrameViol) {
        if (fv.property === "layoutSizingHorizontal") {
          ...
          try {
            var fwWidth = fixNode.width !== void 0 ? fixNode.width : 0;
            var fwExpected = 0;
          ...
          try {
            ...
            if (paints && Array.isArray(paints) && paints.length > propIdx) {
              ...
              if (paint && paint.type === "SOLID" && paint.color) {
                var bestEntry = findBestColorVar(paint.color, fvCat, maps.colorVarEntries);
                if (bestEntry) {
  ...
  async function lintFrame(params) {
    ...
    var nodeId = lintParams ? lintParams.nodeId : void 0;
    var checks = lintParams ? lintParams.checks : void 0;
    ...
    var isPageChild = rootNode.parent !== null && rootNode.parent !== void 0 && rootNode.parent.type === "PAGE";
    var chk = {

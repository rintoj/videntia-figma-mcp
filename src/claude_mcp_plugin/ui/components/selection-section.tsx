        ...
        >
          ...
          >
            ...
            >
              <FilterIcon
                icon={
                  FILTER_OPTIONS.filter(function (o) {
                    return o.value === filterMode;
                  })[0].icon
                }
                color={filterMode !== "selection" ? "#0fa958" : "var(--color-primary)"}
              />
            ...
            return (
              ...
              >
                ...
                <div class="flex items-center gap-1.5 min-w-0 flex-1 overflow-hidden">
                  ...
                  <span
                    class="text-muted-foreground text-[10px] whitespace-nowrap shrink-0"

...
export function SelectionBottomBar(props: SelectionBottomBarProps) {
  if (!props.barVisible && props.checkedCount === 0) return null;

  var isAll = props.checkedCount > 0 && props.checkedCount >= props.totalCount;
  var isPartial = props.checkedCount > 0 && !isAll;
  var isNone = props.checkedCount === 0;

...
export const TOOL_CATEGORY_MAP: Record<string, ToolCategoryEntry> = {
  ...
  create_ellipse: { category: "create" },
  ...
  set_rotation: { category: "modify", secondary: ["layout"] },
  set_layer_order: { category: "modify", secondary: ["layout"] },
  ...
  get_text_opentype_features: { category: "text", secondary: ["read"] },
  ...
  remove_annotation: { category: "document" },
...
export const TOOL_SYNONYMS: Record<string, string[]> = {
  ...
  ligatures: ["get_text_opentype_features"],
  "tabular figures": ["get_text_opentype_features"],
  tnum: ["get_text_opentype_features"],
  "font features": ["get_text_opentype_features"],
  opentype: ["get_text_opentype_features"],
  ...
  reorder: ["set_layer_order", "insert_child"],
  "z order": ["set_layer_order", "insert_child"],
  "z index": ["set_layer_order", "insert_child"],
  "layer order": ["set_layer_order", "insert_child"],
  "bring to front": ["set_layer_order"],
  "send to back": ["set_layer_order"],
  "bring forward": ["set_layer_order"],
  "send backward": ["set_layer_order"],
  rotate: ["set_rotation"],
  ...
  annotation: ["set_annotation", "get_annotations", "set_multiple_annotations", "remove_annotation"],

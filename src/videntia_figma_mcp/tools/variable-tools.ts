  ...
  server.tool(
    ...
    async (params) => {
      try {
        ...
        // The plugin's token-system handlers read snake_case names; the normalizer maps them.
        const spacingResult = await sendCommandToFigma<DesignSystemSubResult>(
          "create_spacing_system",
          normalizeCommandParams("create_spacing_system", {
            collectionId,
        ...
        const typoResult = await sendCommandToFigma<DesignSystemSubResult>(
          "create_typography_system",
          normalizeCommandParams("create_typography_system", {
            collectionId,
        ...
        const radiusResult = await sendCommandToFigma<DesignSystemSubResult>(
          "create_radius_system",
          normalizeCommandParams("create_radius_system", { collectionId, preset: params.radiusPreset }),
        );

  ...
  return (
    <div class="min-h-screen flex items-center justify-center p-4">
      <div class="bg-gray-900 border border-gray-800 rounded-xl p-8 w-full max-w-md">
        ...
        {notice && (
          <div class="bg-green-900/40 border border-green-700 text-green-300 text-sm rounded-lg px-4 py-3 mb-4">
            {notice}
          </div>
        )}
        {error && (
        ...
        <p class="text-center text-sm text-gray-500 mt-4">
          No account?{" "}
          <button onClick={() => onNavigate("register")} class="text-indigo-400 hover:text-indigo-300">
            Create one
          </button>
        </p>
      </div>

      ...
      <div class="min-h-screen flex items-center justify-center p-4">
        <div class="bg-gray-900 border border-gray-800 rounded-xl p-8 w-full max-w-md text-center">
          ...
          <p class="text-gray-400 text-sm">
            We sent a verification link to <strong class="text-white">{email}</strong>. Click it to activate your
            account.
          </p>
          <button onClick={() => onNavigate("login")} class="mt-6 text-sm text-indigo-400 hover:text-indigo-300">
            Back to login
          </button>
        </div>
      </div>
    ...
    <div class="min-h-screen flex items-center justify-center p-4">
      <div class="bg-gray-900 border border-gray-800 rounded-xl p-8 w-full max-w-md">
        ...
        <p class="text-center text-sm text-gray-500 mt-4">
          ...
          <button onClick={() => onNavigate("login")} class="text-indigo-400 hover:text-indigo-300">
            Sign in
          </button>
        </p>
      </div>

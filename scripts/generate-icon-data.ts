/**
 * Build-time codegen script that reads all Lucide SVG files from icons/
 * and produces a TypeScript module with a Map<string, string> (icon name → SVG markup).
 *
...
async function main() {
  ...
  console.log(`Found ${files.length} SVG files in icons/`);

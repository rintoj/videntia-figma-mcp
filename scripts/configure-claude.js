...
config.mcpServers['videntia-figma-mcp'] = {
  command: 'npx',
  args: [`${packageName}@latest`]
};

console.log('Updated configuration for figma-mcp:');
console.log(JSON.stringify(config.mcpServers['videntia-figma-mcp'], null, 2));
...
try {
  ...
  console.log('2. Open Claude Desktop and select "videntia-figma-mcp" from the MCPs list');

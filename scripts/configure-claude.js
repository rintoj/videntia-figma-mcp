...
config.mcpServers['hgraph-figma-mcp'] = {
  command: 'npx',
  args: [`${packageName}@latest`]
};

console.log('Updated configuration for figma-mcp:');
console.log(JSON.stringify(config.mcpServers['hgraph-figma-mcp'], null, 2));
...
try {
  ...
  console.log('2. Open Claude Desktop and select "hgraph-figma-mcp" from the MCPs list');
